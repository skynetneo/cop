...
// Framer Motion expects 'ease' to be a function or array of functions, not a string or array of strings.
// We'll use the built-in easing functions from motion (or you can use a custom cubic bezier array).
...
export const LoaderOne = () => {
  const transition = (x: number) => ({
    ...
    delay: x * 0.2,
    ease: "easeInOut" as any, // motion/react accepts string, but TS expects Easing type. 'as any' resolves the type error.
  });
  return (
