...
// 1. Define the props type for ModalProvider
type ModalProviderProps = {
  children: ReactNode;
  value?: ModalContextType; // The 'value' prop is now officially part of the type
};

// 2. Use the new props type in the component signature
export const ModalProvider = ({ children, value }: ModalProviderProps) => {
  const [internalOpen, setInternalOpen] = useState(false);
  
  // The logic remains the same: use the provided value or fall back to internal state.
  const contextValue = value || { open: internalOpen, setOpen: setInternalOpen };
