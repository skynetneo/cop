...
from tools.playwright.base import (
    BaseBrowserTool,
    lazy_import_playwright_browsers,
)
from tools.playwright.click import ClickTool
from tools.playwright.current_page import CurrentWebPageTool
from tools.playwright.extract_hyperlinks import (
    ExtractHyperlinksTool,
)
from tools.playwright.extract_text import ExtractTextTool
from tools.playwright.get_elements import GetElementsTool
from tools.playwright.navigate import NavigateTool
from tools.playwright.navigate_back import NavigateBackTool
from tools.playwright.screenshot import WebPageScreenshotTool
from tools.playwright.search import WebSearchTool
...
class PlayWrightToolkit(BaseToolkit):
